package com.luma.cacumber.pages;
...
public class GearPage extends Utility {
    ...
    public void sendProductOvernightDuffleQuantity(String quantity){
        sendTextToElement(productDuffleQuantity, quantity);
    }
    ...
    public void sendProductOvernightDuffleQuantityAgain(String quantity){
        sendTextToElement(productQuantityChange, quantity);
    }
